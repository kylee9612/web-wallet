...
//        AccountInfoRequestParams accountInfoRequest = xrpController.getAccountInfoRequest(wallet.classicAddress());
//        AccountInfoResult accountInfoResult = xrpController.getAccountInfo(accountInfoRequest);
